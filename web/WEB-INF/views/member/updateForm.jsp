...
<body>
		...
		<form id="updateForm" action="" method="post">
			<table align="center">
				<tr>
					...
					<td><input type="text" maxlength="13" name="memberId" id="memberId" readonly value="${ sessionScope.memberLogin.id }"></td>
					<td width="100px"></td>
				</tr>
				<tr>
					<td>* 비밀번호</td>
				...
				<tr>
					<td>* 닉네임</td>
					<td><input type="text" maxlength="5" name="nickname" required value="${ sessionScope.memberLogin.nickname }"></td>
				</tr>
				<tr>
					<td>연락처</td>
					<td><input type="tel" name="phone" value="${ sessionScope.memberLogin.phone }"></td>
					<td></td>
				</tr>
				<tr>
					<td>이메일</td>
					<td><input type="email" name="email" value="${ sessionScope.memberLogin.email }"></td>
					<td></td>
				</tr>
				<tr>
					<td>우편번호</td>
	...
	<script>
		const address = "${sessionScope.memberLogin.address}".split("$");
